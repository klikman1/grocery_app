...
class _CartDetailsPageState extends State<CartDetailsPage> {
          ...
          Expanded(
            child: Consumer<CartProvider>(
              builder: (context, provider, child) => ListView.builder(
                ...
                itemCount: provider.carts
                    .firstWhere((ct) => ct.id == cart.id)
                    .products
                    .length,
                // Builds each item in the list
                itemBuilder: (context, index) {
                  final foundCart =
                      provider.carts.firstWhere((ct) => ct.id == cart.id);
                  ...
                  return ProductInTheList(
                    productId: id,
                    // Passes the product ID to the item widget
                    productQuantity: quantity,
                    // Passes the product quantity,
  ...
  /// Widget for the total price section displayed at the bottom of the page
